...
applyTo: '**/Mod/*.cs'
---
Folder này chứa source code của các mods được viết bằng ngôn ngữ lập trình C# sử dụng framework .NET. Mỗi file trong thư mục này đại diện cho một mod cụ thể, bao gồm các tính năng và chức năng mở rộng cho ứng dụng hoặc trò chơi mà bạn đang phát triển.
