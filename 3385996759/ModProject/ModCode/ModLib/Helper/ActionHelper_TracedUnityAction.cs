...
namespace ModLib.Helper
{
    public partial class ActionHelper
    {
        ...
        {
            return (UnityAction<T1, T2, T3>)((v1, v2, v3) => TracedAction(act, cat, fin));
        }
    }
}
