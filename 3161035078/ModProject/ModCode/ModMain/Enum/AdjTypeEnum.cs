...
namespace MOD_nE7UL2.Enum
{
    public class AdjTypeEnum : EnumObject
    {
        ...
        public static AdjTypeEnum RSp { get; } = new AdjTypeEnum("adjType500010007", "0", (wunit) => BattleModifyEvent.GetSpRecoveryBase(wunit));
        ...
        public static AdjTypeEnum BlockChanceMax { get; } = new AdjTypeEnum("adjType500010021", "0.00", (wunit) => BattleModifyEvent.GetBlockMaxBase(wunit));
        public static AdjTypeEnum BlockDmg { get; } = new AdjTypeEnum("adjType500010022", "0", (wunit) => BattleModifyEvent.GetBlockDmgBase(wunit));
        public static AdjTypeEnum EvadeChance { get; } = new AdjTypeEnum("adjType500010023", "0.00", (wunit) => BattleModifyEvent.GetEvadeBase(wunit));
        public static AdjTypeEnum EvadeChanceMax { get; } = new AdjTypeEnum("adjType500010024", "0.00", (wunit) => BattleModifyEvent.GetEvadeMaxBase(wunit));
        ...
        public static AdjTypeEnum SCritChance { get; } = new AdjTypeEnum("adjType500010027", "0.00", (wunit) => BattleModifyEvent.GetSCritChanceBase(wunit));
        public static AdjTypeEnum SCritChanceMax { get; } = new AdjTypeEnum("adjType500010028", "0.00", (wunit) => BattleModifyEvent.GetSCritChanceMaxBase(wunit));
        public static AdjTypeEnum SCritDamage { get; } = new AdjTypeEnum("adjType500010029", "0.00", (wunit) => BattleModifyEvent.GetSCritDamageBase(wunit));
        public static AdjTypeEnum SkillDamage { get; } = new AdjTypeEnum("adjType500010030", "0.00", (wunit) => 100 + 10 * wunit.GetGradeLvl());
