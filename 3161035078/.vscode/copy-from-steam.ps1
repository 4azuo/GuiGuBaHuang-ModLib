# Copy Project 3161035078 from Steam Workshop to Git
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Copy Project 3161035078 from Steam Workshop to Git" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
$sourcePath = Join-Path $steamWorkshopPath "3161035078"
$destinationPath = Join-Path $gitRepositoryPath "3161035078"
...
Write-Host "`nCopying 3161035078 folder from Steam Workshop to Git..." -ForegroundColor Yellow
Copy-WithErrorHandling -Source $sourcePath -Destination $destinationPath

Write-Host "`n========================================" -ForegroundColor Green
Write-Host "✅ COPY COMPLETED SUCCESSFULLY!" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host "Project 3161035078 has been copied from Steam Workshop to Git!" -ForegroundColor White
