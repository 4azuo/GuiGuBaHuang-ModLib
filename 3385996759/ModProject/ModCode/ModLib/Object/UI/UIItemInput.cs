...
namespace ModLib.Object
{
    public class UIItemInput : UIItem<InputField>
    {
        ...
        public UIItemInput(UICustomBase ui, float x, float y, string def, InputField copySource = null) : base(ui, (copySource ?? ui.UISample3.ui.iptDesc).Copy(ui.UIBase).Pos(x, y).Size(180f, 26f).Align().Format(Color.black, 13))
        {
            Init(def);
        }
