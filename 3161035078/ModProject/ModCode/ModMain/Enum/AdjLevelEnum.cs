...
namespace MOD_nE7UL2.Enum
{
    public class AdjLevelEnum : EnumObject
    {
        ...
        public static AdjLevelEnum Beast { get; } = new AdjLevelEnum("Gametool.LS("itemlvl500060006desc")""Myst", 6, 1.7, new Color(255, 106, 106));
        public static AdjLevelEnum Antique { get; } = new AdjLevelEnum("Gametool.LS("itemlvl500060007desc")""Antique", 7, 2.0, new Color(221, 196, 136));
