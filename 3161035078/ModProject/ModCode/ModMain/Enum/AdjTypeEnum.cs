...
namespace MOD_nE7UL2.Enum
{
    public class AdjTypeEnum : EnumObject
    {
        ...
        public static AdjTypeEnum MDp { get; } = new AdjTypeEnum("adjType500010037", 8, "0", (wunit) => 1 * wunit.GetGradeLvl());
        ...
        public static AdjTypeEnum RSp { get; } = new AdjTypeEnum("adjType500010007", 4, "0", (wunit) => 1 * wunit.GetGradeLvl());
        public static AdjTypeEnum RDp { get; } = new AdjTypeEnum("adjType500010038", 9, "0", (wunit) => 0.1 * wunit.GetGradeLvl());
        public static AdjTypeEnum BasisBlade { get; } = new AdjTypeEnum("adjType500010008", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisBlade));
        public static AdjTypeEnum BasisEarth { get; } = new AdjTypeEnum("adjType500010009", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisEarth));
        public static AdjTypeEnum BasisFinger { get; } = new AdjTypeEnum("adjType500010010", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisFinger));
        public static AdjTypeEnum BasisFire { get; } = new AdjTypeEnum("adjType500010011", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisFire));
        public static AdjTypeEnum BasisFist { get; } = new AdjTypeEnum("adjType500010012", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisFist));
        public static AdjTypeEnum BasisFroze { get; } = new AdjTypeEnum("adjType500010013", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisFroze));
        public static AdjTypeEnum BasisPalm { get; } = new AdjTypeEnum("adjType500010014", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisPalm));
        public static AdjTypeEnum BasisSpear { get; } = new AdjTypeEnum("adjType500010015", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisSpear));
        public static AdjTypeEnum BasisSword { get; } = new AdjTypeEnum("adjType500010016", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisSword));
        public static AdjTypeEnum BasisThunder { get; } = new AdjTypeEnum("adjType500010017", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisThunder));
        public static AdjTypeEnum BasisWind { get; } = new AdjTypeEnum("adjType500010018", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisWind));
        public static AdjTypeEnum BasisWood { get; } = new AdjTypeEnum("adjType500010019", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.BasisWood));
        public static AdjTypeEnum Speed { get; } = new AdjTypeEnum("adjType500010020", 1, "0", (wunit) => wunit.GetProperty<int>(UnitPropertyEnum.MoveSpeed));
        ...
        public static AdjTypeEnum Nullify { get; } = new AdjTypeEnum("adjType500010025", 2, "0", (wunit) => 4 * wunit.GetGradeLvl());
        ...
        public static AdjTypeEnum StealHp { get; } = new AdjTypeEnum("adjType500010032", 3, "0.000", (wunit) => 0.8 * wunit.GetGradeLvl());
        public static AdjTypeEnum StealMp { get; } = new AdjTypeEnum("adjType500010033", 4, "0.000", (wunit) => 0.4 * wunit.GetGradeLvl());
        public static AdjTypeEnum StealSp { get; } = new AdjTypeEnum("adjType500010034", 5, "0.000", (wunit) => 0.2 * wunit.GetGradeLvl());
        public static AdjTypeEnum InstantKill { get; } = new AdjTypeEnum("adjType500010035", 1, "0.000", (wunit) => 0.1 * wunit.GetGradeLvl());
        public static AdjTypeEnum SummonPower { get; } = new AdjTypeEnum("adjType500010036", 1, "0.000", (wunit) => 0.5 * wunit.GetGradeLvl());
